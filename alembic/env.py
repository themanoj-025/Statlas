"""Alembic env.py — configured to use Statlas models and config.
...
if settings.database_url:
    ...
    # Default to SQLite for dev; production MUST set DATABASE_URL
    config.set_main_option("sqlalchemy.url", "sqlite+pysqlite:///./data/dev.db")
