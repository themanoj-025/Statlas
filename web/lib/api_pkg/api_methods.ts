import { API_URL } from "./api_core";

export { ApiError };
import { ChatResponse } from "../types_pkg/other_chat";
import type { AnalyticsAlert } from "../types_pkg/other_alert";
import type { AnomalyResult } from "../types_pkg/other_alert";
import { ApiError } from "./api_core";
import type { ArchetypeDetail } from "../types_pkg/other_archetype";
import type { ArchetypeOverview } from "../types_pkg/other_archetype";
import type { ArpuResult } from "../types_pkg/other_tactical";
import type { AssistantQuota } from "../types_pkg/other_chat";
import type { AuditEntry } from "../types_pkg/other_org";
import type { CandidateTemplate } from "../types_pkg/other_transfer";
import type { CheckoutPayload } from "../types_pkg/billing";
import type { ChurnResult } from "../types_pkg/other_tactical";
import type { ConversionFunnel } from "../types_pkg/other_tactical";
import type { CoveragePayload } from "../types_pkg/player";
import type { DashboardSummary } from "../types_pkg/other_dashboard";
import type { DauResult } from "../types_pkg/other_tactical";
import type { EventCoverage } from "../types_pkg/player";
import type { EventMatch } from "../types_pkg/event";
import type { ExecutiveDashboard } from "../types_pkg/other_tactical";
import type { FeatureUsageResult } from "../types_pkg/other_tactical";
import type { FormationResult } from "../types_pkg/other_tactical";
import type { LeaderboardResponse } from "../types_pkg/player";
import type { LeagueHubPayload } from "../types_pkg/league";
import type { LeagueIndexEntry } from "../types_pkg/league";
import type { LeagueStatsRow } from "../types_pkg/league";
import type { LeagueSummary } from "../types_pkg/league";
import type { LimitsPayload } from "../types_pkg/other_chat";
import type { MauResult } from "../types_pkg/other_tactical";
import type { MePayload } from "../types_pkg/billing";
import type { Meta } from "../types_pkg/billing";
import type { OpportunityCard } from "../types_pkg/other_transfer";
import type { OrgDetail } from "../types_pkg/other_org";
import type { OrgInviteResult } from "../types_pkg/other_org";
import type { OrgJoinResult } from "../types_pkg/other_org";
import type { OrgMember } from "../types_pkg/billing";
import type { OrgSettings } from "../types_pkg/other_org";
import type { OrgSummary } from "../types_pkg/other_org";
import type { PassEvent } from "../types_pkg/event";
import type { PassingNetworkResult } from "../types_pkg/event";
import type { PlayerArchetype } from "../types_pkg/player";
import type { PlayerPayload } from "../types_pkg/player";
import type { PortalPayload } from "../types_pkg/other_chat";
import type { PositionGroupMeta } from "../types_pkg/billing";
import type { PositionScarcityOpportunity } from "../types_pkg/other_transfer";
import type { PossessionMap } from "../types_pkg/other_tactical";
import type { PressureMap } from "../types_pkg/other_tactical";
import type { ReportQuotaPayload } from "../types_pkg/other_report";
import type { ReportSummary } from "../types_pkg/other_report";
import type { ReportsPayload } from "../types_pkg/other_report";
import type { RetentionCohort } from "../types_pkg/other_tactical";
import type { SavedSearchesPayload } from "../types_pkg/player";
import type { SearchHistoryPayload } from "../types_pkg/player";
import type { SearchPreset } from "../types_pkg/player";
import type { SearchResult } from "../types_pkg/player";
import type { SearchResults } from "../types_pkg/player";
import type { ShortlistDetail } from "../types_pkg/other_dashboard";
import type { ShortlistMemberships } from "../types_pkg/billing";
import type { ShotEvent } from "../types_pkg/event";
import type { SimilarPlayer } from "../types_pkg/player";
import type { SubscriptionStatusPayload } from "../types_pkg/billing";
import type { TacticalOverview } from "../types_pkg/other_tactical";
import type { TagSuggestions } from "../types_pkg/other_dashboard";
import type { TeamPayload } from "../types_pkg/league";
import type { TransferCandidateResult } from "../types_pkg/other_transfer";
import type { TransferRisk } from "../types_pkg/other_transfer";
import type { TrendPayload } from "../types_pkg/player";
import type { ValuationComparison } from "../types_pkg/other_transfer";
import type { ValuationConfidence } from "../types_pkg/other_transfer";
import type { ValuationGapPlayer } from "../types_pkg/player";
import type { WatchAlertDetail } from "../types_pkg/other_alert";
import type { WatchAlertsPayload } from "../types_pkg/other_alert";
import type { WatchPreferences } from "../types_pkg/other_alert";
import type { WatchesPayload } from "../types_pkg/other_alert";
import type { WorkspaceOverview } from "../types_pkg/other_dashboard";
import { get } from "./api_core";
import { qs } from "./api_core";
export const api = {
