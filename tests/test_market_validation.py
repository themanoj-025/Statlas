...
class TestPlausibilityBounds:
    ...
    def test_valuation_bounds(self) -> None:
        from app.compute.market_validation import MIN_VALUATION_EUR, MAX_VALUATION_EUR
    ...
    def test_transfer_fee_bounds(self) -> None:
        from app.compute.market_validation import MIN_TRANSFER_FEE_EUR, MAX_TRANSFER_FEE_EUR
        assert MIN_TRANSFER_FEE_EUR == 0
        assert MAX_TRANSFER_FEE_EUR == 500_000_000

    def test_contract_bounds(self) -> None:
        from app.compute.market_validation import MAX_CONTRACT_SALARY_EUR, MAX_CONTRACT_YEARS_REMAINING
